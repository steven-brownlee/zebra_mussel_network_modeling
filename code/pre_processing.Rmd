...
na_bbox <- read_sf('data_directory/qgis_bbox.gpkg')
...
write_sf(zm_occ_sf, 'data_directory/dreissnid_occurrences.gpkg')
...
write_sf(road_network, 'data_directory/usdot_road_network.gpkg')
...
write_sf(boundaries, 'data_directory/cec_political_boundaries.gpkg')

write_sf(coastline, 'data_directory/cec_coastline.gpkg')
...
write_sf(pop_places, 'data_directory/cec_populated_places.gpkg')
...
write_sf(lakes, 'data_directory/cec_lakes.gpkg')
