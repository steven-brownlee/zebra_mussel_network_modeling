...
midpoint_collection <- future_map(midpoint_generator(1:250000)) %>% bind_rows()
...
midpoint_collection <- future_map(midpoint_generator(250000:500000)) %>% bind_rows()
...
midpoint_collection <- future_map(midpoint_generator(500000:815410)) %>% bind_rows()
