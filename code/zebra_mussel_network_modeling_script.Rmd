...
metro_template_table <- tibble(index = character(),
                           destination_id = numeric(),
                           origin_id = numeric(),
                           node_position = numeric(),
                           x = numeric(),
...
for (x in 1:length(groups)) {
  ...
  metro_template_table <- bind_rows(metro_template_table, metro_table)
  print(paste('Completed:', x))
}
...
groups <- split(1:101612, ceiling(seq_along(1:101612)/150))

###

lake_template_table <- tibble(index = character(),
                           destination_id = numeric(),
                           origin_id = numeric(),
                           node_position = numeric(),
                           x = numeric(),
...
for (x in 1:length(groups)) {
  ...
  lake_template_table <- bind_rows(lake_template_table, lake_table)
  print(paste('Completed:', x))
}
...
groups <- split(1:101612, ceiling(seq_along(1:101612)/5))

###

ok_template_table <- tibble(index = character(),
                           destination_id = numeric(),
                           origin_id = numeric(),
                           node_position = numeric(),
                           x = numeric(),
...
for (x in 1:length(groups)) {
  ...
  ok_template_table <- bind_rows(ok_template_table, ok_table)
  print(paste('Completed:', x))
}
