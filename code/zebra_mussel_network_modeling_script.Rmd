...
na_lanes <- na_data %>% filter(grepl('lanes', other_tags)) %>% separate_longer_delim(other_tags, delim = ',') %>%  filter(grepl('lanes', other_tags))

na_maxspeed <- na_data %>% filter(grepl('maxspeed', other_tags)) %>% separate_longer_delim(other_tags, delim = ',') %>%  filter(grepl('maxspeed', other_tags))
