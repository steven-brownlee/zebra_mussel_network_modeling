...
osm_list_table <- tibble(osm_slice_list)

osm_slice_one <- osm_list_table %>% slice(1:167) %>% deframe()

osm_slice_one <- osm_list_table %>% slice(1:6) %>% deframe()

osm_slice_two <- osm_list_table %>% slice(168:334) %>% deframe()

osm_slice_three <- osm_list_table %>% slice(334:500) %>% deframe()
