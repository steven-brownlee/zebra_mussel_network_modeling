...
joined_table <- bind_rows(joined)

write_rds(joined_table, 'outputs/overlay_grid_joined/overlay_tables/joined_table.rds')

joined_table <- drop_na(joined_table)
...
write_sf(hex_final, 'outputs/network_components/hex_grid.gpkg')
