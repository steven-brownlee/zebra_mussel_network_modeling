...
with_progress({osm_combined <- big_reader(osm_data_list)})
...
osm_part_one <- osm_combined[1:710]

osm_part_two <- osm_combined[711:1420]

osm_part_three <- osm_combined[1420:2000]
