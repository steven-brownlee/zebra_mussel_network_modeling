...
for (x in 1:length(groups)) {
  ...
  metro_path <- paste('outputs/network_components/routes/metro/metro_route_', x, '.gpkg')
...
for (x in 1:length(groups)) {
  ...
  lake_path <- paste('outputs/network_components/routes/lake/lake_route_', x, '.gpkg')
...
for (x in 1:length(groups)) {
  ...
  ok_path <- paste('outputs/network_components/routes/okanagan/okanagan_route_', x, '.gpkg')
